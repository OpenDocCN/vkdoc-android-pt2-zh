...
当然，用户会希望你的应用在所有这些屏幕上都能正常工作，也许会利用更大的屏幕尺寸来增加更大的价值。为此，Android 1.6 增加了新的功能，以帮助更好地支持这些不同的屏幕尺寸和分辨率，这些功能在后续的 Android 版本中得到了扩展。随着 Android 3.0 的发布，可选的碎片系统作为一种处理不同屏幕尺寸的更强大——尽管更复杂——的方式被引入。Android 文档广泛介绍了使用传统方法和片段方法处理多种屏幕尺寸的机制。我们鼓励你在阅读本章(以及第 28 章)的同时阅读该文档，以充分理解如何最好地应对，或者利用多种屏幕尺寸。
