...
在条件 if()语句体中，声明一个 **long msTime** 变量，然后键入**等于** (=)运算符和**系统**类名。然后按**句号**键，弹出 IntelliJ 弹出方法帮助器对话框，如图[图 9-10](#Fig10) 所示。双击**current time millis()**method 选项，并将其插入到 Java 代码中，以完成声明、命名和设置该 msTime 变量的值的语句。
