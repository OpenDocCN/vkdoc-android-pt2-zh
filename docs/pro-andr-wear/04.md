...
因为这是一个 Pro Android 标题，所以您可能有一些使用 Eclipse ADT IDE 进行 Android 4.4(和更早版本)应用程序开发的经验，它包括一个 **Android SDK 管理器**菜单选项和对话框。在 IntelliJ IDEA 中也可以通过使用**配置![image](img/image00490.jpeg) SDK 管理器**面板序列来访问该实用程序，如图[图 4-5](#Fig5) 所示。
